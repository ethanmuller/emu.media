...
const IndexPage = () => (
  <>
    ...
    <main style={homeMainStyle}>
      <ul>
        <li><strong>Latest:</strong> <a href="https://omg.emu.media/">oh my gosh</a> is a music track with a companion web app. The app lets you change the rate of audio playback.</li>
